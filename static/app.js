...
function getMapSource (mapType) {
  const mapPath = mapType === 'erangel'
    ? 'erangel/v11'
    : 'miramar/v5'
  // if false, will use http://150.109.78.159:20086/maptiles/erangel/v11/{z}/{x}/{y}.png not sure if it is stable or not. But it will have more zoom, up to 5. Local only has up to 4
  let useLocalResource = false
  const mapBase = useLocalResource
    ? '../maptiles'
    : 'http://150.109.78.159:20086/maptiles'
